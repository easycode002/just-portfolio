...
const ResumeSection = ({ title, children }) => (
  <section className="bg-white rounded-lg shadow-sm p-6 md:p-8 print:break-inside-avoid">
    <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-5 pb-2 border-b border-gray-200">
      {title}
    </h2>
...
const Resume = () => {
  return (
    <main className="bg-gray-50 min-h-screen py-8 md:py-12 lg:py-16 px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="container mx-auto max-w-6xl">
        <Header />
        
        <div className="space-y-8 md:space-y-12 mt-8 sm:mt-12">
